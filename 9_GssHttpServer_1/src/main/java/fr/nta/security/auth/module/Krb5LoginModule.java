package fr.nta.security.auth.module;
...
// * <p>
// * Configuration entry for <code>Krb5LoginModule</code> has several options
// * that control the authentication process and additions to the
// * <code>Subject</code>'s private credential set. Irrespective of the
// * options, only when <code>commit</code> is called the Subject's principal
// * set and private credentials set are updated. When <code>commit</code> is
// * called the <code>KerberosPrincipal</code> is added to the
// * <code>Subject</code>'s principal set and <code>KerberosTicket</code>
// * will be added to the <code>Subject</code>'s private credentials.
// * 
// * <p>
// * If the configuration entry for KerberosLoginModule has the option
// * <code>storeKey</code> set to true , then <code>KerberosKey</code> will
// * also be added to the subject's private credentials. <code>KerberosKey</code>,
// * the principal's key will be obtained either from the keytab or derived from
// * user's password
// * 
// * <p>
// * This LoginModule recogonizes the <code>doNotPrompt</code> option. If set to
// * true the user will not be prompted for the password.
// * 
// * <p>
...
// * <code>keyTab</code> in the configuraion entry.
// * 
// * <p>
// * The principal name can be specified in the configuration entry by using the
// * option <code>principal</code> The principal name can either be a simple
// * user name or a service name such as <code>host/mission.eng.sun.com</code>
// * 
// * <p>
// * The following are the list of configuration options supported for
// * <code>Krb5LoginModule</code>
// * <dl>
// * <code>refreshKrb5Config</code>: Set this to true, if you want the
// * configuration to be refreshed before the <code>login</code> method is
// * called.
// * </dl>
// * <p>
// * <code>useTicketCache</code>: Set this to true, if you want the TGT to be
// * obtained from the ticket cache. Set this option to false if you do not want
// * this module to use the ticket cache. (Default is False). This module will
// * search for the tickect cache in the following locations: For Windows 2000, it
// * will use Local Security Authority (LSA) API to get the TGT. On Solaris and
// * Linux it will look for the ticket cache in /tmp/krb5cc_<code>uid</code>
// * where the uid is numeric user identifier. If the ticket cache is not
// * available in either of the above locations, or if we are on a different
// * WIndows platform, it will look for the cache as
// * {user.home}{file.separator}krb5cc_{user.name}. You can override the ticket
// * cache location by using <code>ticketCache</code>
// * 
// * <p>
// * <code>ticketCache</code>: Set this to the name of the ticket cache that
// * contains user's TGT. If this is set, <code>useTicketcache</code> must also
// * be set to true; Otherwise a configuration error will be returned.
// * 
// * <p>
// * <code>doNotPrompt</code>: Set this to true if you do not want to be
// * prompted for the password if credentials can not be obtained from the cache
// * or keytab.(Default is false) If set to true authentication will fail if
// * credentials can not be obtained from the cache or keytab.
// * 
// * <p>
// * <code>useKeyTab</code>:Set this to true if you want the module to get the
// * principal's key from the the keytab.(default value is False) If
// * <code>keyatb</code> is not set then the module will locate the keytab from
// * the Kerberos configuration file. If it is not specifed in the Kerberos
// * configuration file then it will look for the file
// * <code>{user.home}{file.separator}</code>krb5.keytab.
// * 
// * <p>
// * <code>keyTab</code>: Set this to the file name of the keytab to get
// * principal's secret key.
// * 
// * <p>
// * <code>storeKey</code>: Set this to True to if you want the principal's key
// * to be stored in the Subject's private credentials.
// * 
// * <p>
// * <code>principal</code>: The name of the principal that should be used. It
// * could be simple username such as <code>"testuser"</code> or a service name
// * such as <code>"host/testhost.eng.sun.com" </code>. You can use
// * <code>principal</code> option to set the principal when there are
// * credentials for multiple principals in the <code>keyTab</code> or when you
// * want a specific ticket cache only.
// * 
// * <P>
...
// * passwords across different authentication modules:
// * 
// * <pre>
// * 
...
// * and the user can not be prompted for the password.
// * <ul>
// * <p>
// * <code>ticketCache</code> = < filename >;
// * </ul>
// * <p>
// * This is an illegal combination since useTicketCache is not set to true and
// * the ticketCache is set. A configuratin error will occur.
// * <ul>
// * <p>
...
// * </ul>
// * <p>
// * This is an illegal combination since <code>storeKey</code> is set to true
// * but the key can not be obtained either by prompting the user or from the
// * keytab.A configuratin error will occur.
// * <ul>
// * <p>
...
// * <ul>
// * <p>
// * <code>useTicketCache</code> = true <code>ticketCache</code>=< file name ><code>useKeyTab</code> =
// * true <code> keyTab</code>=< keytab filename > <code>principal</code> = <
// * principal name > <code>doNotPrompt</code>=true;
// * </ul>
// * <p>
...
// * <ul>
// * <p>
// * <code>useKeyTab</code> = true <code>keyTab</code>=< file name > <code>storeKey</code>=true
// * <code>principal</code>= < principal name > <code>useTicketCache</code>=true
// * <code>ticketCache</code>=< file name >;
// * </ul>
// * <p>
// * The principal's key will be retrieved from the keytab and added to the <code>Subject</code>'s
// * private credentials. If the key is not available, the user will be prompted
// * for the password; the key derived from the password will be added to the
// * Subject's private credentials set. The client's TGT will be retrieved from
// * the ticket cache and added to the <code>Subject</code>'s private
// * credentials. If the TGT is not available in the ticket cache, it will be
// * obtained using the authentication exchange and added to the Subject's private
// * credentials.
// * 
// * <ul>
// * <p>
...
//	 *            a <code>CallbackHandler</code> for communication with the
...
//		final String isInitiatorValue = ((String) options.get("isInitiator"));
...
//		if (debug) {
//			System.out.print("Debug is  " + debug + " storeKey " + storeKey + " useTicketCache " + useTicketCache + " useKeyTab " + useKeyTab + " doNotPrompt " + doNotPrompt + " ticketCache is "
//					+ ticketCacheName + " isInitiator " + isInitiator + " KeyTab is " + keyTabName + " refreshKrb5Config is " + refreshKrb5Config + " principal is " + princName + " tryFirstPass is "
//					+ tryFirstPass + " useFirstPass is " + useFirstPass + " storePass is " + storePass + " clearPass is " + clearPass + "\n");
//		}
//	}
//
//	/**
...
//				final LoginException le = new LoginException(ke.getMessage());
//				le.initCause(ke);
//				throw le;
//			}
//		}
//		final String principalProperty = System.getProperty("sun.security.krb5.principal");
...
//	 */
//
//	private void attemptAuthentication(final boolean getPasswdFromSharedState) throws LoginException {
//
//		/*
...
//				final LoginException le = new LoginException(e.getMessage());
//				le.initCause(e);
//				throw le;
//			}
//		}
...
//				}
//				if (useKeyTab) {
//					encKey = EncryptionKey.acquireSecretKey(principal, keyTabName);
//					if (debug) {
//						if (encKey != null) {
...
//						}
//
//						cred = Credentials.acquireTGT(principal, encKey, new StringBuffer().append(password));
//
...
//						}
//
//						cred = Credentials.acquireTGT(principal, encKey, password!=null?new StringBuffer().append(password):null);
//					}
//				}
//
...
//			final LoginException ie = new LoginException(ioe.getMessage());
//			ie.initCause(ioe);
//			throw ie;
//		}
//	}
//
//	private void promptForName(final boolean getPasswdFromSharedState) throws LoginException {
...
//			}
//			try {
//				final String defUsername = System.getProperty("user.name");
//
//				final Callback[] callbacks = new Callback[1];
//				final MessageFormat form = new MessageFormat(rb.getString("Kerberos username [[defUsername]]: "));
//				final Object[] source = { defUsername };
...
//	}
//
//	private void promptForPass(final boolean getPasswdFromSharedState) throws LoginException {
//
//		if (getPasswdFromSharedState) {
...
//			try {
//				final Callback[] callbacks = new Callback[1];
//				final String userName = krb5PrincName.toString();
//				final MessageFormat form = new MessageFormat(rb.getString("Kerberos password for [username]: "));
//				final Object[] source = { userName };
...
//	 * <code>Subject</code> located in the <code>LoginModule</code>. It
//	 * adds Kerberos Credentials to the the Subject's private credentials set.
...
//			 */
//
//			final Set privCredSet = subject.getPrivateCredentials();
//			final Set princSet = subject.getPrincipals();
...
//			}
//			if (isInitiator) {
//				final EncryptionKey sessionKey = cred.getSessionKey();
//				kerbTicket = new KerberosTicket(cred.getEncoded(), new KerberosPrincipal(cred.getClient().getName()), new KerberosPrincipal(cred.getServer().getName()), sessionKey.getBytes(),
//						sessionKey.getEType(), cred.getFlags(), cred.getAuthTime(), cred.getStartTime(), cred.getEndTime(), cred.getRenewTill(), cred.getClientAddresses());
//			}
//
//			if (storeKey) {
//				if (encKey == null) {
...
//				}
//				final Integer temp = encKey.getKeyVersionNumber();
//				kerbKey = new KerberosKey(kerbClientPrinc, encKey.getBytes(), encKey.getEType(), (temp == null ? 0 : temp.intValue()));
//
//			}
...
//				encKey = null;
//				if (debug) {
//					System.out.println("Added server's key" + kerbKey);
...
//	 * 
//	 * <p>
//	 * This method removes the <code>Krb5Principal</code> that was added by
...
//		final Iterator it = subject.getPrivateCredentials().iterator();
//		while (it.hasNext()) {
...
public class Krb5LoginModule implements LoginModule {
	...
	/**
	 * process the configuration options Get the TGT either out of cache or from the KDC using the password entered
	...
	private void attemptAuthentication(boolean getPasswdFromSharedState) throws LoginException {
		...
		/*
		 * Check the creds cache to see whether we have TGT for this client principal
		 */
		if (krb5PrincName != null) {
			try {
				principal = new PrincipalName(krb5PrincName.toString(), PrincipalName.KRB_NT_PRINCIPAL);
		...
		try {
			...
			if (cred == null) {
				...
				if (useKeyTab) {
					encKeys = EncryptionKey.acquireSecretKeys(principal, keyTabName);
				...
				if (encKeys == null) {
					...
					encKeys = EncryptionKey.acquireSecretKeys(password, principal.getSalt());
				...
				if (debug) {
					...
					for (int i = 0; i < encKeys.length; i++) {
						System.out.println("EncryptionKey: keyType=" + encKeys[i].getEType() + " keyBytes (hex dump)=" + hd.encode(encKeys[i].getBytes()));
					}
				}
	...
	public boolean commit() throws LoginException {
		...
		/*
		 * Let us add the Krb5 Creds to the Subject's private credentials. The credentials are of type KerberosKey or
		 * KerberosTicket
		 */
		if (succeeded == false) {
			return false;
			...
			/*
			 * Add the Principal (authenticated identity) to the Subject's principal set and add the credentials (TGT or
			 * Service key) to the Subject's private credentials
			 */
